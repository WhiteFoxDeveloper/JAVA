...
public class RoadController
{
    ...
    public static Integer passengerCarMaxHeight = 2000; // mm   Переменная%      максимальная высота легкового авто
    public static Integer controllerMaxHeight = 3500; // mm     Переменная%      максимальная высота всех авто

    public static Integer passengerCarPrice = 100; // RUB       Переменная%      стоймость за легковой авто
    public static Integer cargoCarPrice = 250; // RUB           Переменная%      стоймость за грузовой авто
    public static Integer vehicleAdditionalPrice = 200; // RUB  Переменная%      Стоймость проезда

    public static Integer maxOncomingSpeed = 60; // km/h        Переменная%      максимальная скорость
    public static Integer speedFineGrade = 20; // km/h          Переменная%      ступенька ;D
    public static Integer finePerGrade = 500; // RUB            Переменная%      Это щтраф который в буд. будет * на каждую ступеньку(speedFineGrade) после maxOncomingSpeed
    public static Integer criminalSpeed = 160; // km/h          Переменная%      скорость при которой вызываеться полиция
    ...
    public static void main(String[] args)
    {
        ...
        {                                                                          //
             ...
             */
            Integer carHeight = car.getHeight(); //       Присвоение к переменной%
            Integer price = vehicleAdditionalPrice;//          Переменная%
